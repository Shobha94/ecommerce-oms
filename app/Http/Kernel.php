...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        // App-level proxies/hosts/cors & request hygiene
    ...
    protected $middlewareGroups = [
        ...
        'api' => [
            // If you need SPA cookie auth with Sanctum, uncomment below:
    ...
    protected $middlewareAliases = [
        ...
        'stock.check' => \App\Http\Middleware\StockAvailabilityMiddleware::class,
    ];
}
